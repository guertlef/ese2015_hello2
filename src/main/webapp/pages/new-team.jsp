...
<h1>Register a new team!</h1>
    ...
    <form:form method="post" modelAttribute="formTeam" action="create" id="formTeam" cssClass="form-horizontal" autocomplete="off">
        <fieldset>
            <c:set var="teamNameError"><form:errors path="teamName"/></c:set>
